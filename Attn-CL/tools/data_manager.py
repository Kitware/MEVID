...
class Mars(object):
    ...
    track_train_info_path = osp.join(root, 'track_train_info.txt')
    track_test_info_path = osp.join(root, 'track_test_info.txt')
    query_IDX_path = osp.join(root, 'query_IDX.txt')
