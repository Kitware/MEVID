...
def evaluate_reranking(qf, q_pids, q_camids, q_oids, gf, g_pids, g_camids, g_oids, ranks, cal_method):

    distmat = build_evaluate(qf, gf, cal_method)

    print("Computing CMC and mAP")
    be_cmc, be_mAP = evaluate(distmat, q_pids, g_pids, q_camids, g_camids)
